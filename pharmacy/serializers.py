...
from .models import Product, Supplier, Order, OrderItem, PatientInfo,  Category
...
class OrderGetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['patient', 'status', 'order_date', 'total_amount', 'items']
        # fields = ['patient', 'status', 'items']
        extra_kwargs = {
